...
class KnotHash {
	constructor (input, isPart2){
		// if part 2, has to be parsed into bits
		// if part 1, has to be treated as numbers
		this._lengths = (isPart2) ? this._parse (input) : input.match(/[0-9]+/g);
...
var uiP1 = new KnotHash(text, false);
var uiP2 = new KnotHash(text, true);

var arrP1 = uiP1.round ();
console.log(`Part 1 answer: ${arrP1[0] * arrP1[1]}`);
console.log (`Part 2 answer: ${uiP2.run()}`);
